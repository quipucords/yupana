    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('processing_start_time', models.DateTimeField(null=True)),
                ('processing_end_time', models.DateTimeField(null=True)),
                ('report', models.ForeignKey(null=True, on_delete=django.db.models.deletion.CASCADE, to='api.LegacyReportArchive')),
            ],
            options={
                'abstract': False,
            },
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('processing_start_time', models.DateTimeField(null=True)),
                ('processing_end_time', models.DateTimeField(null=True)),
                ('report', models.ForeignKey(null=True, on_delete=django.db.models.deletion.CASCADE, to='api.LegacyReport')),
            ],
            options={
                'abstract': False,
            },
