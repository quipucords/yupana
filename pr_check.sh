...
export APP_NAME="subscriptions"               # name of app-sre "application" folder this component lives in
export COMPONENT_NAME="yupana"                # name of app-sre "resourceTemplate" in deploy.yaml for this component
export IMAGE="quay.io/cloudservices/yupana"   # the image location on quay
